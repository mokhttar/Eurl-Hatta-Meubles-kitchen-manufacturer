...
function AboutUs() {
  ...
  return (
    <BlurFade delay={0.3}>
      ...
      >
        <div
          className={`rounded-md flex flex-col shadow-lg text-start items-center px-5 justify-center ${PoppinsFont.className}`}
        >
          <div className="w-full lg:w-2/3 text-gray-800">
            ...
            <p className="sm:text-lg text-base mb-8 font-semibold py-2 text-gray-800">
              ...
              réputée pour son savoir-faire exceptionnel et ses designs
              innovants. Notre mission est de transformer votre espace cuisine
              en un havre de fonctionnalité et d'élégance, adapté à vos besoins
              et préférences uniques. Avec un engagement envers la qualité et la
              satisfaction du client, nous offrons une large gamme de solutions
              de cuisine sur mesure, garantissant que chaque projet reflète
              notre dévouement à l'excellence. Découvrez le parfait mélange de
              style et de praticité avec EURL Hatta Meuble, où votre cuisine de
          ...
          <div className="flex flex-col items-center w-full lg:w-2/3 font-semibold">
            ...
            <div className="flex flex-col items-center text-start mb-8">
              ...
              <p className="w-full lg:w-2/3 text-gray-800">
                ...
                auprès de fournisseurs réputés et négocions des tarifs
                compétitifs pour vous faire bénéficier d'un excellent rapport
                qualité-prix. Notre engagement envers la qualité se reflète dans
                notre sélection rigoureuse des produits et notre service client
                attentionné.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-start mb-8">
              ...
              <p className="w-full lg:w-2/3 text-gray-800">
                ...
                francophone expérimentée et attentionnée est là pour vous guider
                à chaque étape du processus. Nous comprenons vos besoins et nous
